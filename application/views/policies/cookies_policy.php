<style type="text/css">
	.background {
		background: url("<?php echo base_url('assets/img/policies/cookie-policy.png'); ?>");
...
<div class="row background">
	...
	<div class="col-md-4 d-flex text-center align-items-center justify-content-center">
		<h2 class="h2-align">Cookie Policy</h2>
	</div>
	<div class="col-md-4"></div>
</div>
<div class="row">
	...
	<div class="col-md-10 term-para">
		<p>This is the Cookie Policy for MediTechnos, accessible from https://meditechnos.com/</p>
