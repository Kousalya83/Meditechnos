<style type="text/css">
	...
	.banner {
		background: url("<?php echo base_url('assets/img/products/prodt_banner.jpg'); ?>");
	...
	.quat-screen {
		background: url("<?php echo base_url('assets/img/products/prodt_ss.png'); ?>");
...
<div class="row banner">
	...
	<div class="col-md-6 d-flex justify-content-center align-items-center text-center">
		<div class="banner-content">
			<h2>Provider DirecTory - ProdT</h2>
			<p class="mb-0">Looking for a hassle free website development service to make a professional website.
</p>
			<h5><b>"ProdT simplifies your Website Development"</b></h5>
		</div>
	</div>
	<div class="col-md-3"></div>
</div>
...
<div class="row service-content">
	...
	<div class="col-md-6 d-flex align-items-center">
		<div class="product-content">
			<p>Introducing Provider DirecTory Tool, an advanced solution developed by Meditechnos to optimize finding high quality medical treatment is now simpler than ever. In the network of Meditechnos Solutions, you can locate a doctor, hospital, urgent care center, and other providers of services.</p>
			<p>ProdT Tool is a powerful and user-friendly software solution designed to help individuals and organizations easily create websites for their practice. It is an efficient platform to promote themselves and integrate other embedded features in the market.</p>
			<!-- <p></p>
			<p></p> -->
		</div>
	</div>
	<div class="col-md-6">
		<img src="<?php echo base_url('assets/img/products/prodt_context.jpg'); ?>" alt="Insurance Eligibility">
			...
			<div class="col-md-4 mb-3 d-flex align-items-stretch justify-content-center">
				<div class="card strip-blue">
					...
					<div class="card-body d-flex flex-column">
						<p class="card-text mb-4">To develop your website as basic or advanced as you'd like, create a ProdT account, choose a design, and use the drag and drop functionality.</p>
					</div>
				</div>
			</div>
			<div class="col-md-4 mb-3 d-flex align-items-stretch justify-content-center">
				<div class="card strip-green">
					...
					<div class="card-body d-flex flex-column">
						<p class="card-text mb-4">The user interface and its design to ensure ease of use and accessibility. The core features and functionalities offered by “ProdT”.</p>
					</div>
				</div>
			</div>
			<div class="col-md-4 mb-3 d-flex align-items-stretch justify-content-center">
				<div class="card strip-blue">
					<span class="top-strip-blue"></span>
					<div class="card-body d-flex flex-column">
						<p class="card-text mb-4">With a crew that is highly skilled in creating unique websites, we recognised the need to organize our business processes in order to keep up with the demands of the market. As a result, we introduced ProdT as a vertical focused on simply website design and development.</p>
					</div>
				</div>
			</div>
		</div>
		<div class="row justify-content-center mb-5">
			<div class="col-md-4 mb-3 d-flex align-items-stretch justify-content-center">
				<div class="card strip-blue">
					<span class="top-strip-blue"></span>
					<div class="card-body d-flex flex-column">
						<p class="card-text mb-4">The several parts that work together to make a website effective, user-friendly, and beneficial. Some elements, like a content list or navigation bar, while others offer consumers a service, such as a contact form or provide generator.</p>
					</div>
				</div>
			</div>
			<!-- <div class="col-md-4 mb-3 d-flex align-items-stretch justify-content-center">
...
<div class="row">
	<div class="col-md-12 key-features">
		<div class="row my-5">
			<div class="col-md-12">
				<h3>Key features and benefits of ProdT - Provider DirecTory</h3>
			</div>		
			<div class="col-md-6 benefits">
				<ul>
					<li>
						<img src="<?php echo base_url('assets/img/about/tick.png'); ?>" alt="->">
						<p><span>Ready Made Templates:</span> We have more than 50 templates to choose from and are easy to build.</p>
					</li>
					<li>
						<img src="<?php echo base_url('assets/img/about/tick.png'); ?>" alt="->">
						<p><span>Form Based Website Building:</span> ProdT users have to choose the sections required and fill the content and it will be built into the website from the chosen template.</p>
					</li>
					<!-- <li>
						<img src="<?php echo base_url('assets/img/about/tick.png'); ?>" alt="->">
						<p><span>Customizable web pages:</span> </p>
					</li> -->
				</ul>
			</div>
			<div class="col-md-6 benefits">
				<ul>
					<li>
						<img src="<?php echo base_url('assets/img/about/tick.png'); ?>" alt="->">
						<p><span>Customizable web pages:</span> ProdT allows users to tailor web pages according to their specific requirements. From simple to complex processes, the tool adapts to different project types and industries, promoting flexibility and efficiency.</p>
					</li>
					<li>
						<img src="<?php echo base_url('assets/img/about/tick.png'); ?>" alt="->">
						<p><span>Improved productivity:</span> It streamlines and project management, reducing time spent on administrative tasks and enhancing overall productivity.</p>
					</li>
					<!-- <li>
						<img src="<?php echo base_url('assets/img/about/tick.png'); ?>" alt="->">
						<p><span></span> </p>
...
<div class="row">
	<div class="col-md-12 quat-screen-mobile">
		<img src="<?php echo base_url('assets/img/products/prodt_ss.png'); ?>" alt="Quat Screen" width="100%">
	</div>
</div>
<div class="row">
...
<div class="row">
	<div class="col-md my-5 quat-center text-center">
		<div style="position: relative;">
			<h5>Need a website for your Practice in a few clicks.</h5>
			<h5><span>ProdT</span> is here to assist.</h5>
			<br>
			<ul>
				<li>
					<a href="<?php echo base_url('product/get_demo/2'); ?>">
						<button type="button" class="bg-but1">GET A WEBSITE</button>
					</a>
				</li>
				<li>
					<a href="<?php echo base_url('product/prodt_login'); ?>"  target="_blank">
